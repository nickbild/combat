...
<p align="center">
<img src="https://github.com/nickbild/combat/raw/main/media/teaser.gif">
</p>
...
That gave me enough cycles, but all of the additional instructions and data could not fit in the 2 KB ROM.  This was an easy fix though, the 6507 can address 4KB ROMs, and many Atari cartridges were 4 KB in size (or even 8 KB through bank switching), so I could just modify the code to extend the ROM size.  I expanded the game to 4 KB.
